class MainMediator {
    constructor({ cartMediator, inventoryMediator, authMediator, paymentMediator, salesMediator }) {
    ...
    async notificar(emisor, evento, datos) {
      switch (evento) {
        case 'agregarAlCarrito':
          return this.cartMediator.agregarAlCarrito(datos.usuarioId, datos.productoId, datos.cantidad);
        case 'obtenerCarrito':
        ...
        case 'actualizarCantidadComponente':
          return this.cartMediator.actualizarCantidadComponente(datos.usuarioId, datos.componentId, datos.newQuantity);
        case 'limpiarCarrito':
          return this.cartMediator.limpiarCarrito(datos.usuarioId);
        case 'eliminarDelCarrito':
          return this.cartMediator.eliminarDelCarrito(datos.usuarioId, datos.productoId);
        ...
        case 'actualizarProducto':
          return this.inventoryMediator.actualizarProducto(datos.id, datos.actualizaciones);
        ...
        case 'enviarConfirmacionCompra':
          return this.authMediator.sendPurchaseConfirmation(datos.email, datos.amount);
        ...
        case 'crearVenta':
          return this.salesMediator.crearVenta(datos.idUsuario, datos.total, datos.productos, datos.fecha);
